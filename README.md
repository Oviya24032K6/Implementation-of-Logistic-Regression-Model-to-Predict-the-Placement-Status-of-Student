...
```
import pandas as pd
data=pd.read_csv("Placement_Data ( 4th exp).csv")
data.head()
data1=data.copy()
data1.head()
...
![image](https://github.com/user-attachments/assets/ad90ca63-d4e6-4bfd-a85e-57fb6bd6d1ae)
![image](https://github.com/user-attachments/assets/70902726-2797-441b-8fc7-5bd20dafe6a8)
